...
// on para caso haja erro na conexão
db.on("error", console.log.bind(console, 'Erro de conexão')) 
// once para abrir a conexão, tentar uma vez fazer a abertura, nome do evento de abertura é o open
db.once("open", ()=>{
...
routes(app) // para usar a rota pelo routes 
//os caminhos estao sendo adicionados pelo routes() em outro documento
